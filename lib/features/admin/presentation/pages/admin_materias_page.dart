    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            const Text('Materias', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500)),
            Text(carrera, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w300, color: Colors.white70)),
          ],
        ),
      ),
      body: Column(
                ...
                Expanded(
                  child: Container(
                    decoration: BoxDecoration(
                      color: const Color(0xFFF1F3F4), // Gris suave del Dashboard
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _MateriaCard(
                  title: 'Compiladores',
                  subtitle: 'Semestre 6 • Ciencias de la Ingeniería',
                          ...
                          onPressed: () {
                            showDialog(
                              ...
                              builder: (context) => MateriaFormModal(
                                ...
                                nombre: title,
                                semestre: subtitle.split('Semestre ')[1].split(' • ')[0],
